...
class BooksLoadState extends State<BooksLoad> {
  ...
  AsInformer informer = AsInformer.setUp(1, LangStrings.fetchingData,
      ...
      case EventConstants.requestSuccessful:
        {
          setState(() {
            showDialog(
                context: context, builder: (context) => justAMinuteDialog());
            informer.hideWidget();
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: FloatingActionButton.extended(
                            ...
                            label: Text(LangStrings.proceed,
                                style: TextStyle(color: ColorUtils.white)),
                            onPressed: () {
                              showDialog(
                                  context: context,
    ...
    return AlertDialog(
      ...
      actions: <Widget>[
        Container(
          margin: EdgeInsets.all(5),
          child: FlatButton(
            child: Text(LangStrings.okayGotIt, style: TextStyle(fontSize: 20)),
            color: Colors.deepOrange,
      ...
      return AlertDialog(
        ...
        actions: <Widget>[
          ...
          Container(
            margin: EdgeInsets.all(5),
            child: FlatButton(
              child: Text(LangStrings.proceed, style: TextStyle(fontSize: 20)),
              color: Colors.deepOrange,
              textColor: Colors.white,
              onPressed: () {
                Navigator.pop(context);
